...
--
-- Host: dockv5-us-east-1c.cij1ovqtmj95.us-east-1.rds.amazonaws.com    Database: dockv5
-- ------------------------------------------------------
...
CREATE TABLE `config` (
  ...
  `barcode_regex` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2018-10-11 12:30:04
