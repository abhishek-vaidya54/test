...
def upgrade():
    op.create_table(
        ...
        sa.Column("firmware_id", sa.Integer(),
                  nullable=False, primary_key=True),
        sa.Column("firmware_group_id", sa.Integer(),
                  nullable=False, primary_key=True),
        ...
        sa.ForeignKeyConstraint(['firmware_group_id'], [
                                'firmware_group.id'], name='fk_firmware_group_assoc_firmware_group'),
    )
