...
def upgrade():
    ...
    op.add_column(
        "keepalive_events", sa.Column("dockIMEI", sa.Unicode(length=45), nullable=True)
    )
    op.add_column(
        "keepalive_events",
        sa.Column("enum_ports", sa.Unicode(length=100), nullable=True),
    )
    op.add_column(
        "keepalive_events",
        sa.Column("occupied_ports", sa.Unicode(length=100), nullable=True),
    )
    op.add_column(
        "keepalive_events", sa.Column("local_sensor_fw", sa.Integer(), nullable=True)
    )
    op.add_column(
        "keepalive_events",
        sa.Column("app_version", sa.Unicode(length=45), nullable=True),
    )
...
def downgrade():
    ...
    op.add_column(
        "raw_event_log", sa.Column("assignment_time", sa.Integer(), nullable=True)
    )
    op.add_column(
        "raw_event_log", sa.Column("clientID", sa.Unicode(length=50), nullable=True)
    )
    op.add_column(
        "raw_event_log", sa.Column("warehouseID", sa.Unicode(length=50), nullable=True)
    )
    op.add_column(
        "raw_event_log", sa.Column("sensorID", sa.Unicode(length=50), nullable=True)
    )
    op.add_column(
        "raw_event_log", sa.Column("athleteID", sa.Unicode(length=50), nullable=True)
    )
    op.add_column(
        "raw_event_log", sa.Column("datarecord_count", sa.Integer(), nullable=True)
    )
    op.add_column("raw_event_log", sa.Column("port", sa.Integer(), nullable=True))
    op.add_column(
        "raw_event_log",
        sa.Column("firmware_version", sa.Unicode(length=45), nullable=True),
    )
    op.add_column(
        "raw_event_log", sa.Column("survey_type", sa.Unicode(length=45), nullable=True)
    )
    op.add_column(
        "raw_event_log", sa.Column("response", sa.Unicode(length=45), nullable=True)
    )
    op.add_column(
        "raw_event_log", sa.Column("filename", sa.Unicode(length=45), nullable=True)
    )
    op.add_column(
        "raw_event_log", sa.Column("batt_percent", sa.Unicode(length=45), nullable=True)
    )
    op.add_column(
        "raw_event_log",
        sa.Column("charge_status", sa.Unicode(length=45), nullable=True),
    )
    op.add_column(
        "raw_event_log", sa.Column("sessionID", sa.Unicode(length=45), nullable=True)
    )
