...
def upgrade():
    op.add_column('engagement_stats', sa.Column('days_worn_haptic_enabled', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('engagement_stats', sa.Column('days_worn_haptic_disabled', sa.Integer(), nullable=False, server_default='0'))
