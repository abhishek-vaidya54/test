...
def upgrade():
    op.add_column('job_function', sa.Column('min_safety_score', sa.Float, nullable=True))
    op.add_column('job_function', sa.Column('max_safety_score', sa.Float, nullable=True))
    op.add_column('job_function', sa.Column('first_quarter_safety_score', sa.Float, nullable=True))
    op.add_column('job_function', sa.Column('median_safety_score', sa.Float, nullable=True))
    op.add_column('job_function', sa.Column('third_quarter_safety_score', sa.Float, nullable=True))
