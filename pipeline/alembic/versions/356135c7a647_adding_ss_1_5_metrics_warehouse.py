...
def upgrade():
    ...
    op.add_column('warehouse', sa.Column('first_quarter_safety_score', sa.Float, nullable=True))
    op.add_column('warehouse', sa.Column('median_safety_score', sa.Float, nullable=True))
    op.add_column('warehouse', sa.Column('third_quarter_safety_score', sa.Float, nullable=True))
