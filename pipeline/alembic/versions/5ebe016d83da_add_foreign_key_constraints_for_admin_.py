...
def upgrade():
    ...
    op.create_foreign_key(
        "fk_ia_client", "industrial_athlete", "client", ["client_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        "fk_ia_warehouse", "industrial_athlete", "warehouse", ["warehouse_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        "fk_ia_shifts", "industrial_athlete", "shifts", ["shift_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        "fk_ia_groups", "industrial_athlete", "groups", ["group_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        "fk_ia_settings", "industrial_athlete", "settings", ["setting_id"], ["id"]
    )
