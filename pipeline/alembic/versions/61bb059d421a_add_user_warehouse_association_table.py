...
def upgrade():
    op.create_table(
        ...
        sa.Column("external_admin_user_id", sa.Integer(), nullable=False, primary_key=True),
        ...
        sa.ForeignKeyConstraint(['warehouse_id'], ['warehouse.id'], name= 'fk_user_warehouse_assoc_warehouse'),
        sa.ForeignKeyConstraint(['external_admin_user_id'], ['external_admin_user.id'], name= 'fk_user_warehouse_assoc_external_admin_user'),
    )
