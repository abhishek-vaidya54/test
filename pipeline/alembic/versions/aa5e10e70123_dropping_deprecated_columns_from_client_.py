...
def downgrade():
    ...
    op.add_column('client', sa.Column('client_regex_code', sa.String(length=255), nullable=True))
    op.add_column('client', sa.Column('account_lock_timeout', sa.Integer(), nullable=True))
