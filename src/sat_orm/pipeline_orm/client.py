...
class Client(Base):
    ...
    # Table Relationships
    industrial_athletes = relationship('IndustrialAthlete',back_populates='client', cascade="delete")
    warehouses = relationship('Warehouse',back_populates='client', cascade="delete")
