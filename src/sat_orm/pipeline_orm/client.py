...
class Client(Base):
    ...
    # Table Relationships
    industrial_athletes = relationship('IndustrialAthlete',back_populates='client', cascade="delete-orphan")
    warehouses = relationship('Warehouse',back_populates='client', cascade="delete-orphan")
