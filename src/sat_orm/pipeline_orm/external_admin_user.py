...
class ExternalAdminUser(Base):
    ...
    def __eq__(self, other):
        ...
        return (self.id == other.id and
                ...
                self.db_created_at  == other.db_created_at and
                self.db_modified_at  == other.db_modified_at)

    @staticmethod
    def create(session, email, username, warehouse_id, client_id):
        external_admin_user = ExternalAdminUser(email=email, username=username, warehouse_id=warehouse_id, client_id=client_id)
    ...
    def get_by_id(session, id):
        external_admin_user = session.query(ExternalAdminUser)\
                                        .filter_by(id=id)\
                                        .first()
        return external_admin_user

    @staticmethod
    def update_by_id(session, id, email=None, username=None, warehouse_id=None, client_id=None):
