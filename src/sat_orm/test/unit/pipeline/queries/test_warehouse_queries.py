...
def test_get_warehouse_valid(test_session, get_warehouse_from_db):
    ...
    res = warehouse_queries.get_warehouse(
...
def test_get_warehouse_invalid_warehouse_id(
    test_session, get_warehouse_from_db, invalid_int
):
    """
...
def test_get_warehouse_invalid_client_id(
    test_session, get_warehouse_from_db, invalid_int
):
    """
