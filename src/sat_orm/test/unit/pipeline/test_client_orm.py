...
def test_client_insert_valid(valid_client_post_event, test_session):
    """
    ...
    assert new_client.contracted_users == int(
        valid_client_post_event["contracted_users"]
    )


def test_client_insert_invalid(invalid_client_post_event, test_session):
    """
...
def test_client_update_valid(valid_client_put_event, test_session):
    ...
    assert new_client.contracted_users == int(
        valid_client_put_event["contracted_users"]
    )


def test_client_update_invalid(invalid_client_put_event, test_session):
    """
    Checks that it returns False
    Input:
        invalid_client_put_event: event that includes invalid data
    return: False
    """
    try:
...
def test_client_delete_invalid(invalid_client_delete_event, test_session):
    """
    Checks that it returns error
    Input:
        invalid_client_delete_event: event that includes invalid data
    return: False
    """
