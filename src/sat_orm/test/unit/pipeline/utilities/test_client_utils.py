...
import random
from sat_orm.constants import VALID_CLIENT_IA_NAME_FORMATS
...
def test_is_valid_client_ia_name_format():
    ...
    Output:
        True
    """
    result = client_utils.is_valid_client_ia_name_format(
        random.choice(VALID_CLIENT_IA_NAME_FORMATS)
    )
    assert result
